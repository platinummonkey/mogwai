...
class TestEdgeIO(BaseMogwaiTestCase):
    ...
    #     e1 = TestEdgeModel.create(v1, v2, test_val=3)
    #     e2 = TestEdgeModel.create(v1, v2, test_val=4)
    ...
    #     e1 = TestEdgeModel.create(v1, v2, test_val=3)
    #     results = TestEdgeModel.get_between(v1, v2)
    ...
    #         e1 = TestEdgeModel.create(v1, None, test_val=3)
    #     with self.assertRaises(ValidationError):
    #         e1 = TestEdgeModel.create(None, v2, test_val=3)
    #     with self.assertRaises(ValidationError):
    ...
    #     e1 = TestEdgeModel.create(v1, v2, test_val=-99, name='e1')
    #     e2 = TestEdgeModel.create(v1, v2, test_val=-100, name='e2')
    #     e3 = TestEdgeModelDouble.create(v1, v2, test_val=-101.0, name='e3')
    #
